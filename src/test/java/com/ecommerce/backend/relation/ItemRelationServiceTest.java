...
//
//    @Mock
//    ItemImageQueryService itemImageQueryService;
//
//    @Nested
...
//            given(itemQueryService.readAll(pageable))
...
//
//            given(itemImageQueryService.readAllByItemIdIn(List.of(1L))).willReturn(itemImageList);
//            given(itemQueryService.readAllByCategoryId(pageable, categoryId))
//                    .willReturn(new PageImpl<>(itemList, pageable, itemList.size()));
//
//            var expected = makeItemReadResponseList(itemList, itemImageList);
//
...
//
//            given(itemImageQueryService.readAllByItemIdIn(List.of(1L))).willReturn(itemImageList);
//            given(itemQueryService.readAllByNameContaining(pageable, searchTitle))
//                    .willReturn(new PageImpl<>(itemList, pageable, itemList.size()));
//
//            var expected = makeItemReadResponseList(itemList, itemImageList);
//
...
//
//            given(itemImageQueryService.readAllByItemIdIn(List.of(1L))).willReturn(itemImageList);
//            given(itemQueryService.readAllByNameContainingAndCategoryId(pageable, searchTitle, categoryId))
//                    .willReturn(new PageImpl<>(itemList, pageable, itemList.size()));
//
//            var expected = makeItemReadResponseList(itemList, itemImageList);
//
