...
class DeliveryApiControllerTest {
    private static final String API_DELIVERY = "/api/deliveries";
    private static final String RETRIEVE_ONE = API_DELIVERY + "/{deliveryId}";
    ...
    @Nested
    @DisplayName("@GetMapping(" + RETRIEVE_ONE + ")")
    class RetrieveOneTest {
        @Test
        @DisplayName("주문에 대한 배송 상세 내용을 조회한다.")
        void retrieveOneTest01() throws Exception {
            ...
            // when
            final ResultActions actual = mockMvc.perform(get(RETRIEVE_ONE, deliveryId)
            ...
            actual
                    ...
                    .andDo(document(DOT + API_DELIVERY + "/retrieveOne"
