...
public class ItemApiController {
    ...
    public MyResponse<Long> register(@RequestPart ItemRequest.Create request,
    ...
    @GetMapping("/search")
    public MyResponse<List<ItemResponse.Read>> search(@PageableDefault(size = 10) Pageable pageable,
